...
const addMessageToConversation = function () {
    ...
    var elem = document.getElementById("conversation__body");
    elem.scrollTop = elem.scrollHeight;
};

// Show chat list.
document.querySelector(".btn--list").addEventListener("click", function () {
    document.querySelector(".container_mask").classList.add("list--active");
});
...
document.querySelector("#chat1").addEventListener("click", function () {
    document.querySelector(".container_mask").classList.remove("list--active");
});
